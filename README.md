...
-DSQLITE3_INCLUDE_DIR=/mnt/storage/easybuild/software/SQLite/3.13.0-GCC-5.4.0-2.26/include \ 
-DSQLITE3_LIBRARY=/mnt/storage/easybuild/software/SQLite/3.13.0-GCC-5.4.0-2.26/lib
```
